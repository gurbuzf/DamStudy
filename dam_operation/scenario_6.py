...
import math
import time
from fitness_scenarios import FitnessCalculator_Scenario_6
import pickle
...
if __name__ == "__main__":
    ...
    update = 60 #mins  
    lead_time = 600 # the time window checked if there will be any flooding 
    lead_time_opt = 180 # the time window used in optimization procedure 
    t0 = 0
    ...
    while t0 < te-lead_time:
        ...
        if flow['8']>31.80/2 or flow['26']>30.40/2 or flow['62']>27.4/2 or flow['89']>16.33/2 or flow['170']>16.33/2:
            ...
            while generation<25: # generation
                ...
                fitnesses = FitnessCalculator_Scenario_6(results, population, state_previous)
    ...
    s_name = '_Scenario6_LT_600_180_U60' 
    #Save data
    print('Saving data..')
