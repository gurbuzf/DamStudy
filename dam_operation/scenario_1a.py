...
import math
import time
from fitness_scenarios import FitnessCalculator_Scenario_1_a
import pickle
...
if __name__ == "__main__":
    ...
    update = 60 #mins
    lead_time = 1080 # the time window used in optimization procedure 
    lead_time2 = 1080 # the time window checked if there will be any flooding 
    t0 = 0
    states_all = []
    ...
    while t0 < te-lead_time2:
        ...
        if flow['0']>32.50/2:
            ...
            while generation<25: # generation
                ...
                fitnesses = FitnessCalculator_Scenario_1_a(results)
    ...
    s_name = '_Scenario1a_LT_1080_1080_U60' 
    #Save data
    print('Saving data..')
