...
import math
import time
from fitness_scenarios import FitnessCalculator_Scenario_2
import pickle
...
if __name__ == "__main__":
    ...
    lead_time2 = 360 # the time window checked if there will be any flooding 
    t0 = 0
    states_all = []
    ...
    while t0 < te-lead_time2:
        ...
        if flow['0']>32.50/2 or flow['81']>17.50/2 or  flow['162']>17.50/2:
            ...
            while generation<25: # generation
                ...
                fitnesses = FitnessCalculator_Scenario_2(results)
    ...
    s_name = '_Scenario2_LT_360_360_U60' 
    #Save data
    print('Saving data..')
